---
title: "Log retention"
description: "Retention is configured per tenant from Settings → Retention in the dashboard. Defaults are 365 days for audit events and 90 days for session records."
---
