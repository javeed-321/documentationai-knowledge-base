...
description: "Endpoints: PATCH /v1/admin/tenants/{tenant_id}/settings — Update per-tenant enforcement flags — superadmin only"
---

**`PATCH /v1/admin/tenants/{tenant_id}/settings`**  
