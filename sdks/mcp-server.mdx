---
title: MCP Server
description: Expose AutoPIL governance as native tools for any MCP-compatible agent — no code changes.
---
...
```text title="evaluate_context — ALLOW response"
...
```text title="evaluate_context — DENY response"
...
```text title="cross-agent isolation DENY"
