...
description: Decide between the embedded decorator and the REST API — and how user identity flows through each.
---
...
<Tabs>
  <Tab title="Embedded decorator" icon="code">
    Fixed identity, same process.
  ...
  <Tab title="REST API" icon="globe">
    Per-request identity, any language.

    ```python title="rest.py"
    import httpx
