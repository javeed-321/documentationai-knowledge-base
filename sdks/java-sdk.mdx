---
title: Java SDK
description: A Jackson-only REST client published as ai.vibrantcapital:autopil-java.
---
...
<Callout kind="info">
  `AutoPILException` (unchecked) carries `getStatusCode()` and `getDetail()`. All request types use the builder pattern. A JUnit 5 test suite is included.
</Callout>
