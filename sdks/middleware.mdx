...
description: Enforce access policy at the HTTP layer for FastAPI and Starlette apps — before your handler runs.
---
...
<Callout kind="info">
  Source type: All events from the middleware are stamped `source_type="api"`, regardless of which guard subclass is in use. This lets the dashboard distinguish HTTP-layer enforcement from SDK-level enforcement.
</Callout>
