---
title: Python SDK
description: The embedded ContextGuard decorator, connecting to a hosted instance, and the async decorator.
---
...
<Steps>
  <Step title="Verify your instance is running" icon="heart-pulse">
  ...
  <Step title="Create a policy in the dashboard" icon="shield">
  ...
  <Step title="Set environment variables" icon="settings">
  ...
  <Step title="Wrap your retrieval function" icon="code">
    Use the `evaluate_context` helper below before every retrieval.
  </Step>

  <Step title="Verify it is working" icon="check">
...
```python title="Record downstream action"
